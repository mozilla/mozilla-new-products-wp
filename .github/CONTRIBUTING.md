...
- Open an Issue at https://github.com/Upstatement/mozilla-labs/issues
...
- Go to https://github.com/Upstatement/mozilla-labs/pulls and open a new pull request with your changes.
...
- Go to the issue tracker and [filter open issues by the `support` label](https://github.com/Upstatement/mozilla-labs/issues?q=is%3Aopen+is%3Aissue+label%3Asupport).
...
- Leave a message when closing saying "Cleaning up stale issue. Please reopen or ping us if and when you're ready to resume this. See the [contributing guidelines](https://github.com/Upstatement/mozilla-labs/blob/master/CONTRIBUTING.md#clean-up-issues-and-prs) for more details."
